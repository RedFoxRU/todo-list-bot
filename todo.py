...
def cmds(dest):
    ...
    cmd.row("⇄ " + "Сменить выбранный лист", "✅ " + "Отметить задачу выполненой")
    cmd.row("📜 " + "Просмотреть все задачи", "💰 " + "Поблагодарить")
    cmd.row("⚙️ " + "Настроить выбранный лист")
    return cmd
...
def startMSG(msg):
    ...
    if cursor.fetchone() == None:
        ...
        "📝 Создать задачу" - создает задачу в списке дел.\n
        "⇄ Сменить выбранный лист" - меняет действующий список.\n
        "✅ Отметить задачу выполненой" - отмечает задачу выполненной.\n
        "📜 Просмотреть все задачи" - выводит весь список дел.\n
